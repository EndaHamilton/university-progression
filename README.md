...
10. The /webapp terminal should give a message that the browser is running on http://localhost:3000
...
```
cd existing_repo
git remote add origin https://gitlab.eeecs.qub.ac.uk/40129192/academics-webdevproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eeecs.qub.ac.uk/40129192/academics-webdevproject/-/settings/integrations)
